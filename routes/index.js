...
router.put('/funcionarios/apagar/:funcionario_id', FuncionarioController.deleteFuncionario)
...
router.get('/tarefas/entrada/:user_id', TarefaController.showTasksInbox)
router.get('/tarefas/enviadas/:user_id', TarefaController.showTasksSent)
router.get('/tarefas/arquivadas/:user_id', TarefaController.showTasksArchived)
router.put('/tarefas/visualizar/:tarefa_id/:user_id', TarefaController.viewTask)
router.put('/tarefas/arquivar/:tarefa_id/:user_id', TarefaController.archiveTask)
...
router.put('/treinamentos/edit/:treinamento_id', TreinamentoController.update)
